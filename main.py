...
bot_token = '6241705584:AAHAwNDAqsWWSQQyiLES6XWvqPzKumzLO54'  # Bot token from Telegram API
api_key = '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'  # API key for OpenAI
chat_id = '86922912'  # ID of the chat where the bot will send messages
